...
<div class="w-full max-w-2xl mx-auto p-6 bg-white rounded shadow">
    ...
    <div class="mt-6 flex gap-4 flex-wrap">
        <a href="{{ route('user/profile.edit') }}" class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 transition">
            Ubah Profil
        </a>
        <a href="{{ route('user/homepage_user') }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded hover:bg-gray-400 transition">
            Kembali
        </a>
        <a href="{{ route('landing_page') }}" class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition">
            Logout
        </a>
    </div>
</div>
